...
const string strMessageMagic = "helloexcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "helloexcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "helloex";
        CTransaction txNew;
        txNew.nTime = 1406683877;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1406683877;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4334456;
		if(fTestNet)
        {
            block.nNonce   = 1;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("62db8f0204ac2c0da10b3f98103fbed9d1ea54a027ba369483038b580b81cd66"));
        block.print();
